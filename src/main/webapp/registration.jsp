...
<div class="container">
    ...
    <form:form method="POST" modelAttribute="userForm" class="form-signin text-center">
        <h3 class="form-signin-heading">Create your account</h3>
        <br/>
        <spring:bind path="username">
            <div class="form-group ${status.error ? 'has-error' : ''}">
                <form:input type="text" path="username" class="form-control" placeholder="Username" required="true"
